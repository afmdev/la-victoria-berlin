...
(function () {
  ...
  mount.outerHTML = [
    ...
    '    <li>',
    '      <a href="https://www.instagram.com/lavictoriaberlin/" target="_blank" rel="noopener" aria-label="La Victoria sur Instagram">',
    ...
    '    </li>',
    '    <li>',
    '      <a href="https://www.facebook.com/lavictoriaberlin" target="_blank" rel="noopener" aria-label="La Victoria sur Facebook">',
    ...
    '    </li>',
    '    <li>',
    '      <a href="https://www.youtube.com/@lavictoriaberlin" target="_blank" rel="noopener" aria-label="La Victoria sur YouTube">',
    ...
    '    </li>',
    '    <li>',
    '      <a href="https://www.threads.net/@lavictoriaberlin" target="_blank" rel="noopener" aria-label="La Victoria sur Threads">',
    ...
    '    </li>',
    '    <li>',
    '      <a href="https://x.com/lavictoriaberlin" target="_blank" rel="noopener" aria-label="La Victoria sur X (Twitter)">',
    ...
    '    <a href="../../datenschutz.html">Confidentialité</a>',
    '  </nav>',
