...
(function () {
  ...
  mount.outerHTML = [
    ...
    '    <li>',
    '      <a href="https://www.instagram.com/lavictoriaberlin/" target="_blank" rel="noopener" aria-label="La Victoria auf Instagram">',
    ...
    '    </li>',
    '    <li>',
    '      <a href="https://www.facebook.com/lavictoriaberlin" target="_blank" rel="noopener" aria-label="La Victoria auf Facebook">',
    ...
    '    </li>',
    '    <li>',
    '      <a href="https://www.youtube.com/@lavictoriaberlin" target="_blank" rel="noopener" aria-label="La Victoria auf YouTube">',
    ...
    '    </li>',
    '    <li>',
    '      <a href="https://www.threads.net/@lavictoriaberlin" target="_blank" rel="noopener" aria-label="La Victoria auf Threads">',
    ...
    '    </li>',
    '    <li>',
    '      <a href="https://x.com/lavictoriaberlin" target="_blank" rel="noopener" aria-label="La Victoria auf X (Twitter)">',
